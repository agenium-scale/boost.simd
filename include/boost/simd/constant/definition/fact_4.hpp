...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Fact_4() BOOST_NOEXCEPT
  -> decltype(functional::fact_4( boost::dispatch::as_<T>{}))
  {
    return functional::fact_4( boost::dispatch::as_<T>{} );
  }
} }
