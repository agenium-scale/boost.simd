...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Seven() BOOST_NOEXCEPT
  -> decltype(functional::seven( boost::dispatch::as_<T>{}))
  {
    return functional::seven( boost::dispatch::as_<T>{} );
  }
} }
