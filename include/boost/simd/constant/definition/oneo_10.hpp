...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Oneo_10()
  BOOST_NOEXCEPT_DECLTYPE(detail::oneo_10( boost::dispatch::as_<T>{}))
  {
    return detail::oneo_10( boost::dispatch::as_<T>{} );
  }
} }
