...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Five() BOOST_NOEXCEPT
  -> decltype(functional::five( boost::dispatch::as_<T>{}))
  {
    return functional::five( boost::dispatch::as_<T>{} );
  }
} }
