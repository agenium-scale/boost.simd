...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pio2_3() BOOST_NOEXCEPT
  -> decltype(functional::pio2_3( boost::dispatch::as_<T>{}))
  {
    return functional::pio2_3( boost::dispatch::as_<T>{} );
  }
} }
