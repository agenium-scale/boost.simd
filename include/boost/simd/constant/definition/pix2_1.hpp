...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pix2_1() BOOST_NOEXCEPT
  -> decltype(functional::pix2_1( boost::dispatch::as_<T>{}))
  {
    return functional::pix2_1( boost::dispatch::as_<T>{} );
  }
} }
