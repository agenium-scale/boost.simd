...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pio_4lo() BOOST_NOEXCEPT
  -> decltype(functional::pio_4lo( boost::dispatch::as_<T>{}))
  {
    return functional::pio_4lo( boost::dispatch::as_<T>{} );
  }
} }
