...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Oneo_120()
  BOOST_NOEXCEPT_DECLTYPE(detail::oneo_120( boost::dispatch::as_<T>{}))
  {
    return detail::oneo_120( boost::dispatch::as_<T>{} );
  }
} }
