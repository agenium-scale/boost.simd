...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Fact_6()
  BOOST_NOEXCEPT_DECLTYPE(detail::fact_6( boost::dispatch::as_<T>{}))
  {
    return detail::fact_6( boost::dispatch::as_<T>{} );
  }

  template<typename T> BOOST_FORCEINLINE
  auto Fact_6(boost::dispatch::as_<T> const&) BOOST_NOEXCEPT_DECLTYPE(Fact_6<T>())
  {
    return Fact_6<T>();
  }
} }
