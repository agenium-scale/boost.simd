...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Hundred() BOOST_NOEXCEPT
  -> decltype(functional::hundred( boost::dispatch::as_<T>{}))
  {
    return functional::hundred( boost::dispatch::as_<T>{} );
  }
} }
