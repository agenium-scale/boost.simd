...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Exp_1() BOOST_NOEXCEPT
  -> decltype(functional::exp_1( boost::dispatch::as_<T>{}))
  {
    return functional::exp_1( boost::dispatch::as_<T>{} );
  }
} }
