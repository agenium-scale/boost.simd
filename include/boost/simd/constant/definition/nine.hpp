...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Nine() BOOST_NOEXCEPT
  -> decltype(functional::nine( boost::dispatch::as_<T>{}))
  {
    return functional::nine( boost::dispatch::as_<T>{} );
  }
} }
