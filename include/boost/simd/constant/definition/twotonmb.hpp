...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Twotonmb() BOOST_NOEXCEPT
  -> decltype(functional::twotonmb( boost::dispatch::as_<T>{}))
  {
    return functional::twotonmb( boost::dispatch::as_<T>{} );
  }
} }
