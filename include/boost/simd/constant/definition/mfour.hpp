...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Mfour() BOOST_NOEXCEPT
  -> decltype(functional::mfour( boost::dispatch::as_<T>{}))
  {
    return functional::mfour( boost::dispatch::as_<T>{} );
  }
} }
