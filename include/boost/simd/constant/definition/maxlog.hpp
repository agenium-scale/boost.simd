...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Maxlog() BOOST_NOEXCEPT
  -> decltype(functional::maxlog( boost::dispatch::as_<T>{}))
  {
    return functional::maxlog( boost::dispatch::as_<T>{} );
  }
} }
