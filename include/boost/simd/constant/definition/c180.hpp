...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto C180() BOOST_NOEXCEPT
  -> decltype(functional::c180( boost::dispatch::as_<T>{}))
  {
    return functional::c180( boost::dispatch::as_<T>{} );
  }
} }
