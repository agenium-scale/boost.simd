...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Logpi() BOOST_NOEXCEPT
  -> decltype(functional::logpi( boost::dispatch::as_<T>{}))
  {
    return functional::logpi( boost::dispatch::as_<T>{} );
  }
} }
