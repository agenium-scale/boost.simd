...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Oneo_180()
  BOOST_NOEXCEPT_DECLTYPE(detail::oneo_180( boost::dispatch::as_<T>{}))
  {
    return detail::oneo_180( boost::dispatch::as_<T>{} );
  }
} }
