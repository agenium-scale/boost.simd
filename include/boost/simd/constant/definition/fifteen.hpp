...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Fifteen() BOOST_NOEXCEPT
  -> decltype(functional::fifteen( boost::dispatch::as_<T>{}))
  {
    return functional::fifteen( boost::dispatch::as_<T>{} );
  }
} }
