...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Log2_em1() BOOST_NOEXCEPT
  -> decltype(functional::log2_em1( boost::dispatch::as_<T>{}))
  {
    return functional::log2_em1( boost::dispatch::as_<T>{} );
  }
} }
