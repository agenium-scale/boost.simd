...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Minlog2() BOOST_NOEXCEPT
  -> decltype(functional::minlog2( boost::dispatch::as_<T>{}))
  {
    return functional::minlog2( boost::dispatch::as_<T>{} );
  }
} }
