...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pio2_1t() BOOST_NOEXCEPT
  -> decltype(functional::pio2_1t( boost::dispatch::as_<T>{}))
  {
    return functional::pio2_1t( boost::dispatch::as_<T>{} );
  }
} }
