...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Log10_ehi() BOOST_NOEXCEPT
  -> decltype(functional::log10_ehi( boost::dispatch::as_<T>{}))
  {
    return functional::log10_ehi( boost::dispatch::as_<T>{} );
  }
} }
