...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Sqrteps() BOOST_NOEXCEPT
  -> decltype(functional::sqrteps( boost::dispatch::as_<T>{}))
  {
    return functional::sqrteps( boost::dispatch::as_<T>{} );
  }
} }
