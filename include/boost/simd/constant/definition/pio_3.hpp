...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pio_3() BOOST_NOEXCEPT
  -> decltype(functional::pio_3( boost::dispatch::as_<T>{}))
  {
    return functional::pio_3( boost::dispatch::as_<T>{} );
  }
} }
