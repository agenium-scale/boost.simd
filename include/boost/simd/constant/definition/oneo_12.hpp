...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Oneo_12()
  BOOST_NOEXCEPT_DECLTYPE(detail::oneo_12( boost::dispatch::as_<T>{}))
  {
    return detail::oneo_12( boost::dispatch::as_<T>{} );
  }
} }
