...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Pio_6() BOOST_NOEXCEPT
  -> decltype(functional::pio_6( boost::dispatch::as_<T>{}))
  {
    return functional::pio_6( boost::dispatch::as_<T>{} );
  }
} }
