...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Radindegr() BOOST_NOEXCEPT
  -> decltype(functional::radindegr( boost::dispatch::as_<T>{}))
  {
    return functional::radindegr( boost::dispatch::as_<T>{} );
  }
} }
