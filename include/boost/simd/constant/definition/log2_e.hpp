...
namespace boost { namespace simd
{
  ...
  template<typename T> BOOST_FORCEINLINE auto Log2_e() BOOST_NOEXCEPT
  -> decltype(functional::log2_e( boost::dispatch::as_<T>{}))
  {
    return functional::log2_e( boost::dispatch::as_<T>{} );
  }
} }
