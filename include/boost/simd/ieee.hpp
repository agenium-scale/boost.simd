...
<center>
 ...
 | @ref ilogb           | @ref ldexp       | @ref mantissa    | @ref maxmag     | @ref maxnum     |
 | @ref maxnummag       | @ref minmag      | @ref minnum      | @ref minnummag  | @ref modf       |
 | @ref negate          | @ref negatenz    | @ref nextafter   | @ref next       | @ref nextpow2   |
 | @ref predecessor     | @ref prev        | @ref safe_max    | @ref safe_min   | @ref saturate   |
 | @ref sbits           | @ref sign        | @ref signnz      | @ref successor  | @ref ulpdist    |
 | @ref ulp             |                  |                  |                 |                 |
</center>
  **/
