...
//==============================================================================
#ifndef BOOST_SIMD_ITERATOR_REALIGNED_INPUT_RANGE_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_REALIGNED_INPUT_RANGE_HPP_INCLUDED
...
/*!
  ...
  **/
  ...
  realigned_input_range( Iterator begin, Iterator end )
  {
    ...
    void *tmp_ptr = (void*)const_cast<type*>(ptr);
    void *ano_ptr = boost::alignment::align_up(tmp_ptr, C*sizeof(type));
    type const* new_ptr = (type const*)(ano_ptr);
