...
//==============================================================================
#ifndef BOOST_SIMD_ITERATOR_ALIGNED_OUTPUT_ITERATOR_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_ALIGNED_OUTPUT_ITERATOR_HPP_INCLUDED
  ...
  **/
                  ...
                  >
  {
    ...
    explicit  aligned_output_iterator(Iterator p) : parent(p)
    {
      ...
      BOOST_ASSERT_MSG
      ( boost::alignment::is_aligned(&(*lp) , C*sizeof(*lp) )
