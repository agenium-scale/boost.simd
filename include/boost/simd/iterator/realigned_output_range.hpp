...
//==============================================================================
#ifndef BOOST_SIMD_ITERATOR_REALIGNED_OUTPUT_RANGE_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_REALIGNED_OUTPUT_RANGE_HPP_INCLUDED
...
/*!
  ...
  **/
  ...
  realigned_output_range( Iterator begin, Iterator end )
  {
    ...
    type const* new_ptr = reinterpret_cast<type const*>(boost::alignment::align_up(reinterpret_cast<std::size_t>(ptr), C*sizeof(type)));
