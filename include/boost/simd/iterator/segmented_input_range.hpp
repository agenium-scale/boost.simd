...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ITERATOR_SEGMENTED_INPUT_RANGE_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_SEGMENTED_INPUT_RANGE_HPP_INCLUDED
  ...
  **/
  ...
  inline segmented_input_range( Iterator b, Iterator e )
  {
    ...
    return std::make_tuple( make_iterator_range (b                    , b+std::min(dz,db) )
                          , aligned_input_range (b+db                 , b+db+sz           )
