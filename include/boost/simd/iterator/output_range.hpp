...
//==============================================================================
#ifndef BOOST_SIMD_ITERATOR_OUTPUT_RANGE_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_OUTPUT_RANGE_HPP_INCLUDED
...
namespace boost { namespace simd
{
  ...
  **/
  ...
  {
    BOOST_ASSERT_MSG
    ( boost::alignment::is_aligned(std::distance(begin,end) , output_iterator<Iterator>::cardinal)
    , "Range being adapted holds a non integral number of SIMD pack."
    );
