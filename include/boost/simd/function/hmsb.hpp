...
/*!
  ...
  Returns a std::bitset build from the most significant bit of each value its
argument.
 ...
 @par Possible output:
  ...
  @return A std::bitset of the size of cardinal(v) containing the most
signiicant bits of each
  elements of v.
**/
