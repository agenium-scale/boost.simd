...
*/
//==================================================================================================
#ifndef BOOST_SIMD_FUNCTION_TOUINT_S_HPP_INCLUDED
#define BOOST_SIMD_FUNCTION_TOUINT_S_HPP_INCLUDED
...
**/
  template<typename T> auto touint_s(T const& x) {}
  ...
  namespace functional
  {
    /*!
      ...
      Function object tied to simd::touint_s

      @see simd::touint_s
    **/
    const boost::dispatch::functor<tag::touint_s_> touint_s = {};
  }
} }
#endif
