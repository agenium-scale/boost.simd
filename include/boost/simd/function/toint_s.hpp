...
*/
//==================================================================================================
#ifndef BOOST_SIMD_FUNCTION_TOINT_S_HPP_INCLUDED
#define BOOST_SIMD_FUNCTION_TOINT_S_HPP_INCLUDED
...
**/
  template<typename T> auto toint_s(T const& x) {}
  ...
  namespace functional
  {
    /*!
      ...
      Function object tied to simd::toint_s

      @see simd::toint_s
    **/
    const boost::dispatch::functor<tag::toint_s_> toint_s = {};
  }
} }
#endif
