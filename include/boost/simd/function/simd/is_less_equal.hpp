...
#ifndef BOOST_SIMD_FUNCTION_SIMD_IS_LESS_EQUAL_HPP_INCLUDED
#define BOOST_SIMD_FUNCTION_SIMD_IS_LESS_EQUAL_HPP_INCLUDED
...
#  endif
#  if BOOST_HW_SIMD_X86_OR_AMD >= BOOST_HW_SIMD_X86_AMD_XOP_VERSION
...
#    include <boost/simd/arch/ppc/vmx/simd/function/is_less_equal.hpp>
#  endif
#endif
