...
*/
//==================================================================================================
#ifndef BOOST_SIMD_FUNCTION_SIMD_IS_GREATER_EQUAL_INCLUDED
#define BOOST_SIMD_FUNCTION_SIMD_IS_GREATER_EQUAL_INCLUDED
...
// #    include <boost/simd/arch/arm/neon/simd/function/is_greater_equal.hpp>
#  endif
#  if BOOST_HW_SIMD_ARM >= BOOST_HW_SIMD_ARM_NEON64_VERSION
// #    include <boost/simd/arch/arm/neon64/simd/function/is_greater_equal.hpp>
#  endif
