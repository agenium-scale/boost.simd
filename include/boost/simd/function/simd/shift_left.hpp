...
*/
//==================================================================================================
#ifndef BOOST_SIMD_FUNCTION_SIMD_SHIFT_LEFT_INCLUDED
#define BOOST_SIMD_FUNCTION_SIMD_SHIFT_LEFT_INCLUDED
...
#    include <boost/simd/arch/x86/avx/simd/function/shift_left.hpp>
#  endif
...
#    include <boost/simd/arch/arm/neon/simd/function/shift_left.hpp>
#  endif
#  if BOOST_HW_SIMD_ARM >= BOOST_HW_SIMD_ARM_NEON64_VERSION
#    include <boost/simd/arch/arm/neon64/simd/function/shift_left.hpp>
#  endif
