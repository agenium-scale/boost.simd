...
namespace boost { namespace simd
{
  namespace tag
  {
    BOOST_DISPATCH_MAKE_TAG(ext, compare_greater_equal_, boost::dispatch::elementwise_<compare_greater_equal_>);
  }
  ...
  BOOST_DISPATCH_FUNCTION_DEFINITION(tag::compare_greater_equal_, compare_greater_equal);
