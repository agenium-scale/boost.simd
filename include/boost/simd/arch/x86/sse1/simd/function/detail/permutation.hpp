...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_SSE1_SIMD_FUNCTION_DETAIL_PERMUTATION_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_SSE1_SIMD_FUNCTION_DETAIL_PERMUTATION_HPP_INCLUDED
...
{
  //============================================================================
  // SSE shuffle use general permutation with special case for some topology
  //============================================================================
  template<std::size_t Cardinal>
  struct sse_permutation : detail::default_permutation<Cardinal>
  {};
  ...
  struct  sse_permutation<2>
  {
    ...
    {
      return call(a0,a1,p,typename details::sse_topology<P,2>::type());
    }
  ...
  struct  sse_permutation<4>
  {
    ...
    {
      return call(a0,a1,p,typename details::sse_topology<P,4>::type());
    }
