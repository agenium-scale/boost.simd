...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_SSE1_SIMD_FUNCTION_DETAIL_TOPOLOGY_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_SSE1_SIMD_FUNCTION_DETAIL_TOPOLOGY_HPP_INCLUDED
...
namespace boost { namespace simd { namespace detail
{
  ...
  struct sse_topology<Permutation,2>
  {
  ...
  //============================================================================
  template<typename Permutation>
  struct sse_topology<Permutation,4>
  {
