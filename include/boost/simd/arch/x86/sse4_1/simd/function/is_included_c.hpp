...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_SSE4_1_SIMD_FUNCTION_IS_INCLUDED_C_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                         ...
                         )
  {
    ...
    {
      return bool(_mm_testz_si128(a1, a0));
    }
  };
  BOOST_DISPATCH_OVERLOAD ( is_included_c_
                          , (typename A0)
                         ...
                         )
  {
                                      ...
                                      , const A0 & a1 ) const BOOST_NOEXCEPT
    {
      ...
      return bool(is_included_c(bitwise_cast<i_t>(a0), bitwise_cast<i_t>(a1)));
    }
  };
