...
/**
  ...
  (See accompnoneing file LICENSE.md or copy at
...
BOOST_DISPATCH_OVERLOAD(none_, (typename A0), bs::sse4_1_,
                        bs::pack_<bd::integer_<A0>, bs::sse_>){
    BOOST_FORCEINLINE bool operator()(const A0 &a0)
        const BOOST_NOEXCEPT{return bool(_mm_testz_si128(a0, Allbits<A0>()));
}
};
