...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_SSE3_SIMD_FUNCTION_REVERSE_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_SSE3_SIMD_FUNCTION_REVERSE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator() ( const A0 & a0) const BOOST_NOEXCEPT
    {
      ...
      return bitwise_cast<A0>(reverse(bitwise_cast<i_t>(a0)));
    }
  };
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator() ( const A0 & a0) const BOOST_NOEXCEPT
    {
      ...
      r[0] = a0[1]; r[1] = a0[0];
      return r;
      // TO DO why this does not work ? :  return {a0[1], a0[0]};
    }
  };
} } }
