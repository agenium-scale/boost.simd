...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_SSE2_FUNCTION_BROADCAST_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_SSE2_FUNCTION_BROADCAST_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return do_(a0,brigand::bool_<(A1::value >= 0 && A1::value < 2)>{});
    }

    static BOOST_FORCEINLINE A0 do_(A0 const& a0, brigand::bool_<true> const&) BOOST_NOEXCEPT
    {
      return _mm_shuffle_pd(a0, a0, _MM_SHUFFLE2(A1::value,A1::value));
    }

    static BOOST_FORCEINLINE A0 do_(A0 const&, brigand::bool_<false> const&) BOOST_NOEXCEPT
    {
      return Zero<A0>();
    }
  };
                          ...
                          )
  {
    BOOST_FORCEINLINE A0 operator()(A0 const& a0, A1 const&) const BOOST_NOEXCEPT
    {
      return do_(a0,brigand::bool_<(A1::value >= 0 && A1::value < 4)>{});
    }
                          ...
                          )
  {
    BOOST_FORCEINLINE A0 operator()(A0 const& a0, A1 const&) const BOOST_NOEXCEPT
    {
      return do_(a0,brigand::bool_<(A1::value >= 0 && A1::value < 8)>{});
    }
