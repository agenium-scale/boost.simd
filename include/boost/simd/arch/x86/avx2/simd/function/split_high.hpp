...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_AVX2_SIMD_FUNCTION_SPLIT_HIGH_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_AVX2_SIMD_FUNCTION_SPLIT_HIGH_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_DISPATCH_OVERLOAD ( split_high_, (typename A0), bs::avx2_
