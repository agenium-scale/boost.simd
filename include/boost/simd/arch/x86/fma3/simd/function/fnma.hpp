...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_X86_FMA3_SIMD_FUNCTION_FNMA_HPP_INCLUDED
#define BOOST_SIMD_ARCH_X86_FMA3_SIMD_FUNCTION_FNMA_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    BOOST_FORCEINLINE A0 operator()(const A0& a0, const A0& a1, const A0& a2) const BOOST_NOEXCEPT
    {
      return _mm256_fnmsub_ps(a0, a1, a2);
    }
  };
