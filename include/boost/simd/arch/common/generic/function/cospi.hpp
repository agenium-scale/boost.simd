...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_COSPI_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_COSPI_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,pi_tag,is_not_scalar_t<A0>,big_tag>::cosa(a0);
    }
  };
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,pi_tag,is_not_scalar_t<A0>,clipped_pio4_tag>::cosa(a0);
    }
  };
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,pi_tag,is_not_scalar_t<A0>,A1>::cosa(a0);
    }
  };
