...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_SINCOSD_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_SINCOSD_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return detail::trig_base <A0,degree_tag,is_not_scalar_t<A0>,big_tag>::sincosa(a0,a2);
    }
  };
