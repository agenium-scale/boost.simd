...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_SINCOSPI_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_FUNCTION_GENERIC_SINCOSPI_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return detail::trig_base <A0,tag::pi_tag,is_not_scalar_t<A0>,tag::big_tag>::sincosa(a0,a2);
    }
  };
