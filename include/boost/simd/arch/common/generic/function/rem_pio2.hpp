...
//     BOOST_FORCEINLINE result operator() (A1 const&, A0 const& a0) const BOOST_NOEXCEPT
//     {
//       typedef typename A1::type selector;
//       return rempio2<selector, void>::rem(a0);
//     }

//     template < class T, class dummy = void> struct rempio2
//     {
//       static BOOST_FORCEINLINE result rem( A0 const&) BOOST_NOEXCEPT
//       {
//         BOOST_ASSERT_MSG(false, "wrong target for rem_pio2");
//         return {Zero<iA0>(), Zero<A0>};
//       }
//     };
