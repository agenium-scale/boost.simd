...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,degree_tag,is_not_scalar_t<A0>,big_tag>::cosa(a0);
    }
  };
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,degree_tag,is_not_scalar_t<A0>,clipped_pio4_tag>::cosa(a0);
    }
  };
