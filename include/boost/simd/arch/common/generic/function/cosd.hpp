...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_GENERIC_FUNCTION_COSD_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_GENERIC_FUNCTION_COSD_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,tag::degree_tag,is_not_scalar_t<A0>,tag::big_tag>::cosa(a0);
    }
  };
  BOOST_DISPATCH_OVERLOAD ( cosd_
                          , (typename A0)
                          ...
                          )
  {
    ...
    {
      return detail::trig_base<A0,tag::degree_tag,is_not_scalar_t<A0>,tag::clipped_pio4_tag>::cosa(a0);
    }
  };
  BOOST_DISPATCH_OVERLOAD ( cosd_
