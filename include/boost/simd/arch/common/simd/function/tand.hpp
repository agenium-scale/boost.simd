...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_TAND_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_TAND_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_DISPATCH_OVERLOAD_IF ( tand_
