...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_DIVROUND2EVEN_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_DIVROUND2EVEN_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
                                   ...
                                   ,  const A0& a0, const A0& a1) const BOOST_NOEXCEPT
    {
      ...
      ivtype d0 = saturated_(toint)(div(round2even, tofloat(a0l), tofloat(a1l)));
      ivtype d1 = saturated_(toint)(div(round2even, tofloat(a0h), tofloat(a1h)));
                            ...
                            )
  {
                                   ...
                                   ,  const A0& a0, const A0& a1) const BOOST_NOEXCEPT
    {
      ...
      std::tie(a0l, a0h) = bs::split(a0);
      std::tie(a1l, a1h) = bs::split(a1);
      ivtype d0 = saturated_(touint)(div(round2even, tofloat(a0l), tofloat(a1l)));
      ivtype d1 = saturated_(touint)(div(round2even, tofloat(a0h), tofloat(a1h)));
      return saturated_(group)(d0, d1);
    }
  };
                         ...
                         )
  {
                                   ...
                                   ,   const A0& a0, const A0& a1) const BOOST_NOEXCEPT
    {
      ...
      std::tie(a0l, a0h) = bs::split(a0);
      std::tie(a1l, a1h) = bs::split(a1);
      ivtype d0 = div(round2even, a0l, a1l);
      ivtype d1 = div(round2even, a0h, a1h);
      return saturated_(group)(d0, d1);
    }
  };
