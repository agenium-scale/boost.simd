...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_SHUFFLE_PATTERN_BROADCAST_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SIMD_FUNCTION_SHUFFLE_PATTERN_BROADCAST_HPP_INCLUDED
...
namespace boost { namespace simd
{
  namespace detail
  {
    ...
    // Prevent ambiguity with fully mapped 1-cardinal shuffles
    template<int P> struct is_broadcast<P> : std::false_type {};
  }

  // -----------------------------------------------------------------------------------------------
  // Broadcast pattern hierarchy
  template<int P0, typename P>
  struct  broadcast_pattern : detail::any_pattern_<broadcast_pattern<P0, P>>
  {
    static const std::size_t static_size  = P::static_size;
    static const int index                = P0;
    using parent = detail::any_pattern_<broadcast_pattern<P0, P>>;
  };
} }
