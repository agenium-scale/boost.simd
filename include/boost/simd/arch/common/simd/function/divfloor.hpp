...
namespace boost { namespace simd { namespace ext
{
                             ...
                             )
   {
      BOOST_FORCEINLINE A0 operator()( const A0& a0, const A0& a1) const BOOST_NOEXCEPT
      {
        ...
        bs::split(a0, a0l, a0h );
        bs::split(a1, a1l, a1h );
        ivtype d0 = /*saturated_TODO*/(toint)(divfloor(tofloat(a0l), tofloat(a1l)));
        ivtype d1 = /*saturated_TODO*/(toint)(divfloor(tofloat(a0h), tofloat(a1h)));
        return groups(d0, d1);
      }
   };
                             ...
                             )
   {
      BOOST_FORCEINLINE A0 operator()( const A0& a0, const A0& a1) const BOOST_NOEXCEPT
      {
        ...
        bs::split(a0, a0l, a0h );
        bs::split(a1, a1l, a1h );
        ivtype d0 = /*saturated_TODO*/(touint)(divfloor(tofloat(a0l), tofloat(a1l)));
        ivtype d1 =/*saturated_TODO*/(touint)(divfloor(tofloat(a0h), tofloat(a1h)));
        return groups(d0, d1);
      }
   };
