...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    T do_( T const& x, K const&, bm::list<N...> const&) BOOST_NOEXCEPT
    {
      return T( extract<N::value>(x)..., extract<N::value>(x)... );
    }

    template<typename K> static BOOST_FORCEINLINE
    T do_( T const& x, K const&, bm::list<> const&) BOOST_NOEXCEPT
    {
    ...
    do_( T const& x, aggregate_storage const&, bm::list<N...> const&) BOOST_NOEXCEPT
    {
