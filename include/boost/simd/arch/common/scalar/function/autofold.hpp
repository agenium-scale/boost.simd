...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOFOLD_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOFOLD_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                  ...
                                  )
  {
    ...
    BOOST_FORCEINLINE result_t do_(Arg a0, aggregate_storage const&) const
    {
      bd::functor<F>      f;
      bd::functor<BinOp> op;
    ...
    template<typename K>
    BOOST_FORCEINLINE result_t do_(Arg a0, K const&) const
    {
                                  ...
                                  )
  {
    ...
    BOOST_FORCEINLINE pr_t do_(Arg a0, aggregate_storage const&) const
    {
      bd::functor<F>      f;
      bd::functor<BinOp> op;
    ...
    template<typename K>
    BOOST_FORCEINLINE pr_t do_(Arg a0, K const&) const
    {
    ...
    BOOST_FORCEINLINE pr_t operator()(bs::splatted_tag const&, Arg a0) const
    {
      return do_( a0, typename Arg::traits::storage_kind{});
    }
  };
