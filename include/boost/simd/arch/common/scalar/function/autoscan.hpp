...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOSCAN_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOSCAN_HPP_INCLUDED
...
namespace boost { namespace simd { namespace detail
{
  ...
  template<int Step> struct scan_mask
  {
    ...
    static BOOST_FORCEINLINE V mask(V z, brigand::list<N...> const&)
    {
      using pi_t = boost::dispatch::as_integer_t<V>;
      return z & pi_t( apply<typename pi_t::value_type, N::value>::type::value... );
    }
    template<typename V> static BOOST_FORCEINLINE V mask(V z)
    {
  ...
  template<int Step, int Cardinal> struct scan
  {
    ...
    BOOST_FORCEINLINE U operator()(Op op, V a0, U z) const BOOST_NOEXCEPT
    {
...
namespace boost { namespace simd { namespace ext
{
                                  ...
                                  )
  {
    ...
    result_t do_( function_t op, result_t const&, Arg a0
    ...
    result_t do_( function_t const&, result_t const&
                , Arg a0, K const&, brigand::list<N> const&
                )
    {
      return a0;
    }
    ...
    result_t do_( function_t op, result_t z, Arg a0
    ...
    BOOST_FORCEINLINE result_t operator()(Arg a0) const
    {
