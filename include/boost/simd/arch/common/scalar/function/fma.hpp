...
namespace boost { namespace simd { namespace ext
{
  ...
  {
    BOOST_FORCEINLINE
    A0 operator() ( A0 a0, A0 a1, A0 a2, bs::std_tag const&) const BOOST_NOEXCEPT
    {
                          ...
                          )
  {
    BOOST_FORCEINLINE A0 operator() ( A0 a0, A0 a1, A0 a2) const BOOST_NOEXCEPT
    {
      ...
      return static_cast<A0>(fma(static_cast<u_t>(a0)
                                , static_cast<u_t>(a1)
                                , static_cast<u_t>(a2)));
    }
  };
  ...
  {
    BOOST_FORCEINLINE A0 operator() ( A0 a0, A0 a1, A0 a2
                                    , bs::accurate_tag const&) const BOOST_NOEXCEPT
    {
  ...
  {
    BOOST_FORCEINLINE A0 operator() ( A0 a0, A0 a1, A0 a2
                                    , bs::nooverflow_tag const&) const BOOST_NOEXCEPT
    {
      A0 p, rp, s, rs;
      two_prod(a0, a1, p, rp);
      two_add(p, a2, s, rs);
