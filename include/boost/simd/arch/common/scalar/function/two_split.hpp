...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_TWO_SPLIT_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_TWO_SPLIT_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    BOOST_FORCEINLINE result_t operator() ( A0 a) const BOOST_NOEXCEPT
    {
