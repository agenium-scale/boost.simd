...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_ALL_REDUCE_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_ALL_REDUCE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace detail
{
  ...
  template<int Step> struct butterfly
  {
    ...
    BOOST_FORCEINLINE
    auto  operator()(Op op, V a0) const BOOST_NOEXCEPT
...
namespace boost { namespace simd { namespace ext
{
                                    ...
                                    )
  {
    ...
    result_t fold_( function_t op, Neutral z, Arg a0
    ...
    operator()(function_t op, Neutral z, Arg a0) const
    {
