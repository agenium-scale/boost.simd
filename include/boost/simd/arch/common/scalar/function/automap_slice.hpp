...
**/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOMAP_SLICE_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_SCALAR_FUNCTION_AUTOMAP_SLICE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                  ...
                                  )
  {
    ...
    BOOST_FORCEINLINE
    auto  operator()(bd::functor<Opt> o, const Args&... a) const BOOST_NOEXCEPT
                                  ...
                                  )
  {
    ...
    BOOST_FORCEINLINE
    auto  operator()(Decorator d, const Args&... a) const BOOST_NOEXCEPT
          -> decltype( combine( func_t{}(slice_low (a)...), func_t{}(slice_high(a)...) ) )
    {
                                  ...
                                  )
  {
    ...
    operator()(Decorator d, bd::functor<Opt> o, const Args&... a) const BOOST_NOEXCEPT
          -> decltype( combine( func_t{}(o,slice_low (a)...), func_t{}(o,slice_high(a)...) ) )
    {
