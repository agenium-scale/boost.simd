...
namespace boost { namespace simd { namespace ext
{
  ...
  {
    BOOST_FORCEINLINE void operator() ( A0 a0, A0& rest, A0& ipart) const BOOST_NOEXCEPT
    {
      ipart = simd::trunc(a0);
      rest    = a0 - ipart;
    }
  ...
  {
    BOOST_FORCEINLINE A0 operator() (const std_tag&,  A0 a0, A0& ipart) const BOOST_NOEXCEPT
    {
      A0 rest = std::modf(a0,&ipart);
      return rest;
    }
  };
