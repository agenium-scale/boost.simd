...
//==============================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_DETAIL_GENERIC_GAMMALN_KERNEL_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_DETAIL_GENERIC_GAMMALN_KERNEL_HPP_INCLUDED
...
namespace boost { namespace simd
{
  namespace detail
  {
    ...
    struct gammaln_kernel < A0, float >
    {
      ...
      {
        // log gamma(x+2), -.5 < x < .5
        return horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 8,
    ...
    struct gammaln_kernel < A0, double >
    {
      ...
      {
        return BOOST_SIMD_HORNER_RAT(s_t, 6, 7, x,
