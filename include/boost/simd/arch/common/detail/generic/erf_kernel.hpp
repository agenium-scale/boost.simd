  ...
  namespace detail
  {
    ...
    struct erf_kernel1 < A0, double >
    {
      ...
      static BOOST_FORCEINLINE A0 erf1(const A0& x, const A0& y, A0& ysq) BOOST_NOEXCEPT
      {
        ...
        return x *  BOOST_SIMD_HORNER_RAT(s_t, 5, 5, ysq,
      ...
      {
        return BOOST_SIMD_HORNER_RAT(s_t, 9, 9, y,
      ...
      static BOOST_FORCEINLINE A0 erf3(const A0& , const A0& y) BOOST_NOEXCEPT
      {
        ...
        A0 ysq = rec(sqr(y));
        A0 res = ysq*BOOST_SIMD_HORNER_RAT(s_t, 6, 6, ysq,
    ...
    struct erf_kernel < A0, float >
    {
      ...
      {
        return horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 6,
      ...
      static BOOST_FORCEINLINE A0 erfc2(const A0& z)
      {
        ...
        return horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 11,
      ...
      static BOOST_FORCEINLINE A0 erfc3(const A0& z)
      {
        ...
        return  oneminus(z)* horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 9,
                                                     (
    ...
    struct erf_kernel < A0, double >
    {
      ...
      static BOOST_FORCEINLINE A0 erf1(const A0& xx)
      {
        return BOOST_SIMD_HORNER_RAT(s_t, 5, 5, xx,
      ...
      {
        return BOOST_SIMD_HORNER_RAT(s_t, 7, 7, x,
                              (0x0ull,                // 0
      ...
      {
        return  horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 14,
