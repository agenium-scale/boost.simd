...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_COMMON_DETAIL_GENERIC_SINHC_KERNEL_HPP_INCLUDED
#define BOOST_SIMD_ARCH_COMMON_DETAIL_GENERIC_SINHC_KERNEL_HPP_INCLUDED
  ...
  namespace detail
  {
    ...
    struct sinhc_kernel < A0, double >
    {
      ...
      static  BOOST_FORCEINLINE A0 compute(const A0& x2) BOOST_NOEXCEPT
      {
        ...
        return oneplus( x2*horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 4,
           ...
           horner<BOOST_SIMD_HORNER_COEFF_T(s_t, 4,
