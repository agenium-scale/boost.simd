  ...
  namespace detail
  {
    ...
    struct invtrig_base<A0,tag::radian_tag,tag::not_simd_type, double>
    {
      static BOOST_FORCEINLINE A0 asin(A0 a0) BOOST_NOEXCEPT
      {
        ...
        {
          zz = oneminus(x);
          const A0 vp = zz*horner< BOOST_SIMD_HORNER_COEFF_T(A0, 5,
                    ...
                    horner< BOOST_SIMD_HORNER_COEFF_T(A0, 5,
        ...
        {
          zz = sqr(x);
          A0 z = zz*horner< BOOST_SIMD_HORNER_COEFF_T(A0, 6,
                  ...
                  horner< BOOST_SIMD_HORNER_COEFF_T(A0, 6,
                                          (0x3ff0000000000000ll,
      ...
      static BOOST_FORCEINLINE A0 kernel_atan(A0 a0) BOOST_NOEXCEPT
      {
        ...
        A0 z = sqr(x);
        z = z*horner< BOOST_SIMD_HORNER_COEFF_T(A0, 5,
