...
namespace boost { namespace simd
{
  /*!
    ...
    @defgroup group-boolean Boolean functions
      ...
      These functions provides scalar and SIMD algorithms for testing properties of values.
      Tests such as checks for validity, infinity, sign and others are provided. As for @ref
      group-boolean, those functions handle and return typed logical types.
  **/
