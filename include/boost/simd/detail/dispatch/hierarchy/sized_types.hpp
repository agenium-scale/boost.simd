...
namespace boost { namespace dispatch
{
  ...
  **/
  ...
  struct sized_type_ : std::conditional < behave_as<T, std::is_floating_point<boost::nsm::_1>>::value
                                        , floating_<T>
                                        ...
                                        >::type
  {
    ...
    using parent = typename std::conditional< behave_as<T, std::is_floating_point<boost::nsm::_1>>::value
                                            , floating_<T>
                                            , signed_integral_<T,sign_of_t<T>>
                                            >::type;
  };
