...
STF_CASE_TPL( "Check Log2_e behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log2_e<T>(); };

  auto pack  = bs::Log2_e<pack_t>();
  auto hpack = bs::Log2_e<hpack_t>();
  auto dpack = bs::Log2_e<dpack_t>();
