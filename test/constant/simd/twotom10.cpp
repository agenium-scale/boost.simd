...
STF_CASE_TPL( "Check Twotom10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twotom10<T>(); };

  auto pack  = bs::Twotom10<pack_t>();
  auto hpack = bs::Twotom10<hpack_t>();
  auto dpack = bs::Twotom10<dpack_t>();
