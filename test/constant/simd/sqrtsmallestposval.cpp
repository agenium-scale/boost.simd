...
STF_CASE_TPL( "Check Sqrtsmallestposval behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrtsmallestposval<T>(); };

  auto pack  = bs::Sqrtsmallestposval<pack_t>();
  auto hpack = bs::Sqrtsmallestposval<hpack_t>();
  auto dpack = bs::Sqrtsmallestposval<dpack_t>();
