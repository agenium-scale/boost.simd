...
STF_CASE_TPL( "Check Pio_6 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio_6<T>(); };

  auto pack  = bs::Pio_6<pack_t>();
  auto hpack = bs::Pio_6<hpack_t>();
  auto dpack = bs::Pio_6<dpack_t>();
