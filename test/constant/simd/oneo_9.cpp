...
STF_CASE_TPL( "Check Oneo_9 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_9<T>(); };

  auto pack  = bs::Oneo_9<pack_t>();
  auto hpack = bs::Oneo_9<hpack_t>();
  auto dpack = bs::Oneo_9<dpack_t>();
