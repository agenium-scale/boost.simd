...
STF_CASE_TPL( "Check Minlog2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Minlog2<T>(); };

  auto pack  = bs::Minlog2<pack_t>();
  auto hpack = bs::Minlog2<hpack_t>();
  auto dpack = bs::Minlog2<dpack_t>();
