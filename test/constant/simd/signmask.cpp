...
STF_CASE_TPL( "Check Signmask behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Signmask<T>(); };

  auto pack  = bs::Signmask<pack_t>();
  auto hpack = bs::Signmask<hpack_t>();
  auto dpack = bs::Signmask<dpack_t>();
