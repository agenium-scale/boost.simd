...
STF_CASE_TPL( "Check Euler behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Euler<T>(); };

  auto pack  = bs::Euler<pack_t>();
  auto hpack = bs::Euler<hpack_t>();
  auto dpack = bs::Euler<dpack_t>();
