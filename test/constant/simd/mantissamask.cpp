...
STF_CASE_TPL( "Check Mantissamask behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mantissamask<T>(); };

  auto pack  = bs::Mantissamask<pack_t>();
  auto hpack = bs::Mantissamask<hpack_t>();
  auto dpack = bs::Mantissamask<dpack_t>();
