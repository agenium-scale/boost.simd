...
STF_CASE_TPL( "Check Cgold behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Cgold<T>(); };

  auto pack  = bs::Cgold<pack_t>();
  auto hpack = bs::Cgold<hpack_t>();
  auto dpack = bs::Cgold<dpack_t>();
