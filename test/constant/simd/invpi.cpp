...
STF_CASE_TPL( "Check Invpi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invpi<T>(); };

  auto pack  = bs::Invpi<pack_t>();
  auto hpack = bs::Invpi<hpack_t>();
  auto dpack = bs::Invpi<dpack_t>();
