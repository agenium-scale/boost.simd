...
STF_CASE_TPL( "Check Maxexponent behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxexponent<T>(); };

  auto pack  = bs::Maxexponent<pack_t>();
  auto hpack = bs::Maxexponent<hpack_t>();
  auto dpack = bs::Maxexponent<dpack_t>();
