...
STF_CASE_TPL( "Check Greatestnoninteger behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Greatestnoninteger<T>(); };

  auto pack  = bs::Greatestnoninteger<pack_t>();
  auto hpack = bs::Greatestnoninteger<hpack_t>();
  auto dpack = bs::Greatestnoninteger<dpack_t>();
