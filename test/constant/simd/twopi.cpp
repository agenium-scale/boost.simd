...
STF_CASE_TPL( "Check Twopi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twopi<T>(); };

  auto pack  = bs::Twopi<pack_t>();
  auto hpack = bs::Twopi<hpack_t>();
  auto dpack = bs::Twopi<dpack_t>();
