...
STF_CASE_TPL( "Check Threepio_4 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Threepio_4<T>(); };

  auto pack  = bs::Threepio_4<pack_t>();
  auto hpack = bs::Threepio_4<hpack_t>();
  auto dpack = bs::Threepio_4<dpack_t>();
