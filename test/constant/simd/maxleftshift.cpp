...
STF_CASE_TPL( "Check Maxleftshift behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxleftshift<T>(); };

  auto pack  = bs::Maxleftshift<pack_t>();
  auto hpack = bs::Maxleftshift<hpack_t>();
  auto dpack = bs::Maxleftshift<dpack_t>();
