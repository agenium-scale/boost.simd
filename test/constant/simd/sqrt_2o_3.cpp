...
STF_CASE_TPL( "Check Sqrt_2o_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrt_2o_3<T>(); };

  auto pack  = bs::Sqrt_2o_3<pack_t>();
  auto hpack = bs::Sqrt_2o_3<hpack_t>();
  auto dpack = bs::Sqrt_2o_3<dpack_t>();
