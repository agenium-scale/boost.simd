...
STF_CASE_TPL( "Check Pio2_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_3<T>(); };

  auto pack  = bs::Pio2_3<pack_t>();
  auto hpack = bs::Pio2_3<hpack_t>();
  auto dpack = bs::Pio2_3<dpack_t>();
