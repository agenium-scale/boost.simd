...
STF_CASE_TPL( "Check Fact_5 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_5<T>(); };

  auto pack  = bs::Fact_5<pack_t>();
  auto hpack = bs::Fact_5<hpack_t>();
  auto dpack = bs::Fact_5<dpack_t>();
