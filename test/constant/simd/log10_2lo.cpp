...
STF_CASE_TPL( "Check Log10_2lo behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log10_2lo<T>(); };

  auto pack  = bs::Log10_2lo<pack_t>();
  auto hpack = bs::Log10_2lo<hpack_t>();
  auto dpack = bs::Log10_2lo<dpack_t>();
