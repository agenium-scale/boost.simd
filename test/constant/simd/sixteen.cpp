...
STF_CASE_TPL( "Check Sixteen behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sixteen<T>(); };

  auto pack  = bs::Sixteen<pack_t>();
  auto hpack = bs::Sixteen<hpack_t>();
  auto dpack = bs::Sixteen<dpack_t>();
