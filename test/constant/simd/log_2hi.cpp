...
STF_CASE_TPL( "Check Log_2hi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log_2hi<T>(); };

  auto pack  = bs::Log_2hi<pack_t>();
  auto hpack = bs::Log_2hi<hpack_t>();
  auto dpack = bs::Log_2hi<dpack_t>();
