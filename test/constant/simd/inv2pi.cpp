...
STF_CASE_TPL( "Check Inv2pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Inv2pi<T>(); };

  auto pack  = bs::Inv2pi<pack_t>();
  auto hpack = bs::Inv2pi<hpack_t>();
  auto dpack = bs::Inv2pi<dpack_t>();
