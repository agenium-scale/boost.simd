...
STF_CASE_TPL( "Check Maxexponentm1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxexponentm1<T>(); };

  auto pack  = bs::Maxexponentm1<pack_t>();
  auto hpack = bs::Maxexponentm1<hpack_t>();
  auto dpack = bs::Maxexponentm1<dpack_t>();
