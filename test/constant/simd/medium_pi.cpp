...
STF_CASE_TPL( "Check Medium_pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Medium_pi<T>(); };

  auto pack  = bs::Medium_pi<pack_t>();
  auto hpack = bs::Medium_pi<hpack_t>();
  auto dpack = bs::Medium_pi<dpack_t>();
