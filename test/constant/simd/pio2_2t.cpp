...
STF_CASE_TPL( "Check Pio2_2t behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_2t<T>(); };

  auto pack  = bs::Pio2_2t<pack_t>();
  auto hpack = bs::Pio2_2t<hpack_t>();
  auto dpack = bs::Pio2_2t<dpack_t>();
