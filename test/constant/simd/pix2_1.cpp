...
STF_CASE_TPL( "Check Pix2_1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pix2_1<T>(); };

  auto pack  = bs::Pix2_1<pack_t>();
  auto hpack = bs::Pix2_1<hpack_t>();
  auto dpack = bs::Pix2_1<dpack_t>();
