...
STF_CASE_TPL( "Check Oneo_6 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_6<T>(); };

  auto pack  = bs::Oneo_6<pack_t>();
  auto hpack = bs::Oneo_6<hpack_t>();
  auto dpack = bs::Oneo_6<dpack_t>();
