...
STF_CASE_TPL( "Check Nbdigits behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Nbdigits<T>(); };

  auto pack  = bs::Nbdigits<pack_t>();
  auto hpack = bs::Nbdigits<hpack_t>();
  auto dpack = bs::Nbdigits<dpack_t>();
