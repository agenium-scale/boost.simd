...
STF_CASE_TPL( "Check Fiveo_8 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fiveo_8<T>(); };

  auto pack  = bs::Fiveo_8<pack_t>();
  auto hpack = bs::Fiveo_8<hpack_t>();
  auto dpack = bs::Fiveo_8<dpack_t>();
