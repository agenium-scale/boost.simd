...
STF_CASE_TPL( "Check Fact_7 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_7<T>(); };

  auto pack  = bs::Fact_7<pack_t>();
  auto hpack = bs::Fact_7<hpack_t>();
  auto dpack = bs::Fact_7<dpack_t>();
