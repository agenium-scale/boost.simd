...
STF_CASE_TPL( "Check Powlargelim behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Powlargelim<T>(); };

  auto pack  = bs::Powlargelim<pack_t>();
  auto hpack = bs::Powlargelim<hpack_t>();
  auto dpack = bs::Powlargelim<dpack_t>();
