...
STF_CASE_TPL( "Check Threeeps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Threeeps<T>(); };

  auto pack  = bs::Threeeps<pack_t>();
  auto hpack = bs::Threeeps<hpack_t>();
  auto dpack = bs::Threeeps<dpack_t>();
