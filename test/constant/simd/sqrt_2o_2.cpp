...
STF_CASE_TPL( "Check Sqrt_2o_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrt_2o_2<T>(); };

  auto pack  = bs::Sqrt_2o_2<pack_t>();
  auto hpack = bs::Sqrt_2o_2<hpack_t>();
  auto dpack = bs::Sqrt_2o_2<dpack_t>();
