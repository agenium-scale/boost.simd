...
STF_CASE_TPL( "Check Maxlog behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxlog<T>(); };

  auto pack  = bs::Maxlog<pack_t>();
  auto hpack = bs::Maxlog<hpack_t>();
  auto dpack = bs::Maxlog<dpack_t>();
