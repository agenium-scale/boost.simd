...
STF_CASE_TPL( "Check Pio_2lo behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio_2lo<T>(); };

  auto pack  = bs::Pio_2lo<pack_t>();
  auto hpack = bs::Pio_2lo<hpack_t>();
  auto dpack = bs::Pio_2lo<dpack_t>();
