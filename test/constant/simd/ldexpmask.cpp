...
STF_CASE_TPL( "Check Ldexpmask behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Ldexpmask<T>(); };

  auto pack  = bs::Ldexpmask<pack_t>();
  auto hpack = bs::Ldexpmask<hpack_t>();
  auto dpack = bs::Ldexpmask<dpack_t>();
