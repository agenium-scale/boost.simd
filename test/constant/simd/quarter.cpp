...
STF_CASE_TPL( "Check Quarter behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Quarter<T>(); };

  auto pack  = bs::Quarter<pack_t>();
  auto hpack = bs::Quarter<hpack_t>();
  auto dpack = bs::Quarter<dpack_t>();
