...
STF_CASE_TPL( "Check Pio_4lo behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio_4lo<T>(); };

  auto pack  = bs::Pio_4lo<pack_t>();
  auto hpack = bs::Pio_4lo<hpack_t>();
  auto dpack = bs::Pio_4lo<dpack_t>();
