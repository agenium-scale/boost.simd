...
STF_CASE_TPL( "Check Nbmantissabits behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Nbmantissabits<T>(); };

  auto pack  = bs::Nbmantissabits<pack_t>();
  auto hpack = bs::Nbmantissabits<hpack_t>();
  auto dpack = bs::Nbmantissabits<dpack_t>();
