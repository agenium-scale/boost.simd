...
STF_CASE_TPL( "Check Mfour behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mfour<T>(); };

  auto pack  = bs::Mfour<pack_t>();
  auto hpack = bs::Mfour<hpack_t>();
  auto dpack = bs::Mfour<dpack_t>();
