...
STF_CASE_TPL( "Check Sqrtvalmax behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrtvalmax<T>(); };

  auto pack  = bs::Sqrtvalmax<pack_t>();
  auto hpack = bs::Sqrtvalmax<hpack_t>();
  auto dpack = bs::Sqrtvalmax<dpack_t>();
