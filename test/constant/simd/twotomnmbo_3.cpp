...
STF_CASE_TPL( "Check Twotomnmbo_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twotomnmbo_3<T>(); };

  auto pack  = bs::Twotomnmbo_3<pack_t>();
  auto hpack = bs::Twotomnmbo_3<hpack_t>();
  auto dpack = bs::Twotomnmbo_3<dpack_t>();
