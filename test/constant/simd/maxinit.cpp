...
STF_CASE_TPL( "Check Maxinit behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxinit<T>(); };

  auto pack  = bs::Maxinit<pack_t>();
  auto hpack = bs::Maxinit<hpack_t>();
  auto dpack = bs::Maxinit<dpack_t>();
