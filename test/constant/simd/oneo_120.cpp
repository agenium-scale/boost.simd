...
STF_CASE_TPL( "Check Oneo_120 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_120<T>(); };

  auto pack  = bs::Oneo_120<pack_t>();
  auto hpack = bs::Oneo_120<hpack_t>();
  auto dpack = bs::Oneo_120<dpack_t>();
