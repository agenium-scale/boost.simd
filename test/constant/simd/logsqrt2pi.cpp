...
STF_CASE_TPL( "Check Logsqrt2pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Logsqrt2pi<T>(); };

  auto pack  = bs::Logsqrt2pi<pack_t>();
  auto hpack = bs::Logsqrt2pi<hpack_t>();
  auto dpack = bs::Logsqrt2pi<dpack_t>();
