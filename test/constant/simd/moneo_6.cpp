...
STF_CASE_TPL( "Check Moneo_6 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Moneo_6<T>(); };

  auto pack  = bs::Moneo_6<pack_t>();
  auto hpack = bs::Moneo_6<hpack_t>();
  auto dpack = bs::Moneo_6<dpack_t>();
