...
STF_CASE_TPL( "Check Twothird behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twothird<T>(); };

  auto pack  = bs::Twothird<pack_t>();
  auto hpack = bs::Twothird<hpack_t>();
  auto dpack = bs::Twothird<dpack_t>();
