...
STF_CASE_TPL( "Check Mnine behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mnine<T>(); };

  auto pack  = bs::Mnine<pack_t>();
  auto hpack = bs::Mnine<hpack_t>();
  auto dpack = bs::Mnine<dpack_t>();
