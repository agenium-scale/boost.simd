...
STF_CASE_TPL( "Check Log2_em1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log2_em1<T>(); };

  auto pack  = bs::Log2_em1<pack_t>();
  auto hpack = bs::Log2_em1<hpack_t>();
  auto dpack = bs::Log2_em1<dpack_t>();
