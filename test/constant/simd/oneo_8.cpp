...
STF_CASE_TPL( "Check Oneo_8 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_8<T>(); };

  auto pack  = bs::Oneo_8<pack_t>();
  auto hpack = bs::Oneo_8<hpack_t>();
  auto dpack = bs::Oneo_8<dpack_t>();
