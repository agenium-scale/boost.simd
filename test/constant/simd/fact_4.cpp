...
STF_CASE_TPL( "Check Fact_4 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_4<T>(); };

  auto pack  = bs::Fact_4<pack_t>();
  auto hpack = bs::Fact_4<hpack_t>();
  auto dpack = bs::Fact_4<dpack_t>();
