...
STF_CASE_TPL( "Check Oneo_10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_10<T>(); };

  auto pack  = bs::Oneo_10<pack_t>();
  auto hpack = bs::Oneo_10<hpack_t>();
  auto dpack = bs::Oneo_10<dpack_t>();
