...
STF_CASE_TPL( "Check Pio2_1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_1<T>(); };

  auto pack  = bs::Pio2_1<pack_t>();
  auto hpack = bs::Pio2_1<hpack_t>();
  auto dpack = bs::Pio2_1<dpack_t>();
