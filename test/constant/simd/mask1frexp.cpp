...
STF_CASE_TPL( "Check Mask1frexp behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mask1frexp<T>(); };

  auto pack  = bs::Mask1frexp<pack_t>();
  auto hpack = bs::Mask1frexp<hpack_t>();
  auto dpack = bs::Mask1frexp<dpack_t>();
