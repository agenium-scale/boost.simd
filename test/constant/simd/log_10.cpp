...
STF_CASE_TPL( "Check Log_10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log_10<T>(); };

  auto pack  = bs::Log_10<pack_t>();
  auto hpack = bs::Log_10<hpack_t>();
  auto dpack = bs::Log_10<dpack_t>();
