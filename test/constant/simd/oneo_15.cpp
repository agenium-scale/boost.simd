...
STF_CASE_TPL( "Check Oneo_15 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_15<T>(); };

  auto pack  = bs::Oneo_15<pack_t>();
  auto hpack = bs::Oneo_15<hpack_t>();
  auto dpack = bs::Oneo_15<dpack_t>();
