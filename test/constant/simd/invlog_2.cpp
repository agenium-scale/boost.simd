...
STF_CASE_TPL( "Check Invlog_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invlog_2<T>(); };

  auto pack  = bs::Invlog_2<pack_t>();
  auto hpack = bs::Invlog_2<hpack_t>();
  auto dpack = bs::Invlog_2<dpack_t>();
