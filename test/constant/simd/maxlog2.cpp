...
STF_CASE_TPL( "Check Maxlog2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxlog2<T>(); };

  auto pack  = bs::Maxlog2<pack_t>();
  auto hpack = bs::Maxlog2<hpack_t>();
  auto dpack = bs::Maxlog2<dpack_t>();
