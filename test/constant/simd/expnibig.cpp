...
STF_CASE_TPL( "Check Expnibig behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Expnibig<T>(); };

  auto pack  = bs::Expnibig<pack_t>();
  auto hpack = bs::Expnibig<hpack_t>();
  auto dpack = bs::Expnibig<dpack_t>();
