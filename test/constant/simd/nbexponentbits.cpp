...
STF_CASE_TPL( "Check Nbexponentbits behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Nbexponentbits<T>(); };

  auto pack  = bs::Nbexponentbits<pack_t>();
  auto hpack = bs::Nbexponentbits<hpack_t>();
  auto dpack = bs::Nbexponentbits<dpack_t>();
