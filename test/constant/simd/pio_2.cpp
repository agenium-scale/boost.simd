...
STF_CASE_TPL( "Check Pio_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio_2<T>(); };

  auto pack  = bs::Pio_2<pack_t>();
  auto hpack = bs::Pio_2<hpack_t>();
  auto dpack = bs::Pio_2<dpack_t>();
