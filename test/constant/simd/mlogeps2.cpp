...
STF_CASE_TPL( "Check Mlogeps2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mlogeps2<T>(); };

  auto pack  = bs::Mlogeps2<pack_t>();
  auto hpack = bs::Mlogeps2<hpack_t>();
  auto dpack = bs::Mlogeps2<dpack_t>();
