...
STF_CASE_TPL( "Check Log10_pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log10_pi<T>(); };

  auto pack  = bs::Log10_pi<pack_t>();
  auto hpack = bs::Log10_pi<hpack_t>();
  auto dpack = bs::Log10_pi<dpack_t>();
