...
STF_CASE_TPL( "Check Eleven behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Eleven<T>(); };

  auto pack  = bs::Eleven<pack_t>();
  auto hpack = bs::Eleven<hpack_t>();
  auto dpack = bs::Eleven<dpack_t>();
