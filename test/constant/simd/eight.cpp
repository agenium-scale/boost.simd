...
STF_CASE_TPL( "Check Eight behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Eight<T>(); };

  auto pack  = bs::Eight<pack_t>();
  auto hpack = bs::Eight<hpack_t>();
  auto dpack = bs::Eight<dpack_t>();
