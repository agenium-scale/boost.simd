...
STF_CASE_TPL( "Check Mhalf behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mhalf<T>(); };

  auto pack  = bs::Mhalf<pack_t>();
  auto hpack = bs::Mhalf<hpack_t>();
  auto dpack = bs::Mhalf<dpack_t>();
