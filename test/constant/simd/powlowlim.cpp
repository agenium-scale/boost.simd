...
STF_CASE_TPL( "Check Powlowlim behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Powlowlim<T>(); };

  auto pack  = bs::Powlowlim<pack_t>();
  auto hpack = bs::Powlowlim<hpack_t>();
  auto dpack = bs::Powlowlim<dpack_t>();
