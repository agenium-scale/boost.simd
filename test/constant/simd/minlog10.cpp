...
STF_CASE_TPL( "Check Minlog10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Minlog10<T>(); };

  auto pack  = bs::Minlog10<pack_t>();
  auto hpack = bs::Minlog10<hpack_t>();
  auto dpack = bs::Minlog10<dpack_t>();
