...
STF_CASE_TPL( "Check Fouropi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fouropi<T>(); };

  auto pack  = bs::Fouropi<pack_t>();
  auto hpack = bs::Fouropi<hpack_t>();
  auto dpack = bs::Fouropi<dpack_t>();
