...
STF_CASE_TPL( "Check Invsqrt_2pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invsqrt_2pi<T>(); };

  auto pack  = bs::Invsqrt_2pi<pack_t>();
  auto hpack = bs::Invsqrt_2pi<hpack_t>();
  auto dpack = bs::Invsqrt_2pi<dpack_t>();
