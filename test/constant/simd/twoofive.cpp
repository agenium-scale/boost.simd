...
STF_CASE_TPL( "Check Twoofive behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twoofive<T>(); };

  auto pack  = bs::Twoofive<pack_t>();
  auto hpack = bs::Twoofive<hpack_t>();
  auto dpack = bs::Twoofive<dpack_t>();
