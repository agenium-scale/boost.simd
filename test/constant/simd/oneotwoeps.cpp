...
STF_CASE_TPL( "Check Oneotwoeps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneotwoeps<T>(); };

  auto pack  = bs::Oneotwoeps<pack_t>();
  auto hpack = bs::Oneotwoeps<hpack_t>();
  auto dpack = bs::Oneotwoeps<dpack_t>();
