...
STF_CASE_TPL( "Check Twotonmb behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twotonmb<T>(); };

  auto pack  = bs::Twotonmb<pack_t>();
  auto hpack = bs::Twotonmb<hpack_t>();
  auto dpack = bs::Twotonmb<dpack_t>();
