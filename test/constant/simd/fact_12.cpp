...
STF_CASE_TPL( "Check Fact_12 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_12<T>(); };

  auto pack  = bs::Fact_12<pack_t>();
  auto hpack = bs::Fact_12<hpack_t>();
  auto dpack = bs::Fact_12<dpack_t>();
