...
STF_CASE_TPL( "Check Twoopi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twoopi<T>(); };

  auto pack  = bs::Twoopi<pack_t>();
  auto hpack = bs::Twoopi<hpack_t>();
  auto dpack = bs::Twoopi<dpack_t>();
