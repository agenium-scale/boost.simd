...
STF_CASE_TPL( "Check Mseven behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mseven<T>(); };

  auto pack  = bs::Mseven<pack_t>();
  auto hpack = bs::Mseven<hpack_t>();
  auto dpack = bs::Mseven<dpack_t>();
