...
STF_CASE_TPL( "Check Mindenormal behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mindenormal<T>(); };

  auto pack  = bs::Mindenormal<pack_t>();
  auto hpack = bs::Mindenormal<hpack_t>();
  auto dpack = bs::Mindenormal<dpack_t>();
