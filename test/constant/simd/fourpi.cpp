...
STF_CASE_TPL( "Check Fourpi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fourpi<T>(); };

  auto pack  = bs::Fourpi<pack_t>();
  auto hpack = bs::Fourpi<hpack_t>();
  auto dpack = bs::Fourpi<dpack_t>();
