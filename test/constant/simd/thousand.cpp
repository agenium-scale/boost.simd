...
STF_CASE_TPL( "Check Thousand behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Thousand<T>(); };

  auto pack  = bs::Thousand<pack_t>();
  auto hpack = bs::Thousand<hpack_t>();
  auto dpack = bs::Thousand<dpack_t>();
