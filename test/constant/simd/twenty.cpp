...
STF_CASE_TPL( "Check Twenty behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twenty<T>(); };

  auto pack  = bs::Twenty<pack_t>();
  auto hpack = bs::Twenty<hpack_t>();
  auto dpack = bs::Twenty<dpack_t>();
