...
STF_CASE_TPL( "Check Thirdrooteps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Thirdrooteps<T>(); };

  auto pack  = bs::Thirdrooteps<pack_t>();
  auto hpack = bs::Thirdrooteps<hpack_t>();
  auto dpack = bs::Thirdrooteps<dpack_t>();
