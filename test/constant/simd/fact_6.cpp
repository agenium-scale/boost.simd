...
STF_CASE_TPL( "Check Fact_6 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_6<T>(); };

  auto pack  = bs::Fact_6<pack_t>();
  auto hpack = bs::Fact_6<hpack_t>();
  auto dpack = bs::Fact_6<dpack_t>();
