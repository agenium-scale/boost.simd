...
STF_CASE_TPL( "Check Oneo_12 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_12<T>(); };

  auto pack  = bs::Oneo_12<pack_t>();
  auto hpack = bs::Oneo_12<hpack_t>();
  auto dpack = bs::Oneo_12<dpack_t>();
