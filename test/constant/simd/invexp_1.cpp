...
STF_CASE_TPL( "Check Invexp_1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invexp_1<T>(); };

  auto pack  = bs::Invexp_1<pack_t>();
  auto hpack = bs::Invexp_1<hpack_t>();
  auto dpack = bs::Invexp_1<dpack_t>();
