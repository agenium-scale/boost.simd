...
STF_CASE_TPL( "Check Seven behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Seven<T>(); };

  auto pack  = bs::Seven<pack_t>();
  auto hpack = bs::Seven<hpack_t>();
  auto dpack = bs::Seven<dpack_t>();
