...
STF_CASE_TPL( "Check Pix2_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pix2_3<T>(); };

  auto pack  = bs::Pix2_3<pack_t>();
  auto hpack = bs::Pix2_3<hpack_t>();
  auto dpack = bs::Pix2_3<dpack_t>();
