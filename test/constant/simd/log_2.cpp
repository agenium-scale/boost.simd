...
STF_CASE_TPL( "Check Log_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log_2<T>(); };

  auto pack  = bs::Log_2<pack_t>();
  auto hpack = bs::Log_2<hpack_t>();
  auto dpack = bs::Log_2<dpack_t>();
