...
STF_CASE_TPL( "Check Log10_2hi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log10_2hi<T>(); };

  auto pack  = bs::Log10_2hi<pack_t>();
  auto hpack = bs::Log10_2hi<hpack_t>();
  auto dpack = bs::Log10_2hi<dpack_t>();
