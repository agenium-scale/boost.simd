...
STF_CASE_TPL( "Check Sqrt_2opi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrt_2opi<T>(); };

  auto pack  = bs::Sqrt_2opi<pack_t>();
  auto hpack = bs::Sqrt_2opi<hpack_t>();
  auto dpack = bs::Sqrt_2opi<dpack_t>();
