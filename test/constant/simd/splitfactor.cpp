...
STF_CASE_TPL( "Check Splitfactor behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Splitfactor<T>(); };

  auto pack  = bs::Splitfactor<pack_t>();
  auto hpack = bs::Splitfactor<hpack_t>();
  auto dpack = bs::Splitfactor<dpack_t>();
