...
STF_CASE_TPL( "Check Minlog behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Minlog<T>(); };

  auto pack  = bs::Minlog<pack_t>();
  auto hpack = bs::Minlog<hpack_t>();
  auto dpack = bs::Minlog<dpack_t>();
