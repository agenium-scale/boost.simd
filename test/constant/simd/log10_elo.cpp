...
STF_CASE_TPL( "Check Log10_elo behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log10_elo<T>(); };

  auto pack  = bs::Log10_elo<pack_t>();
  auto hpack = bs::Log10_elo<hpack_t>();
  auto dpack = bs::Log10_elo<dpack_t>();
