...
STF_CASE_TPL( "Check Pio2_3t behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_3t<T>(); };

  auto pack  = bs::Pio2_3t<pack_t>();
  auto hpack = bs::Pio2_3t<hpack_t>();
  auto dpack = bs::Pio2_3t<dpack_t>();
