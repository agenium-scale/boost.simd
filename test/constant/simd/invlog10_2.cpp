...
STF_CASE_TPL( "Check Invlog10_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invlog10_2<T>(); };

  auto pack  = bs::Invlog10_2<pack_t>();
  auto hpack = bs::Invlog10_2<hpack_t>();
  auto dpack = bs::Invlog10_2<dpack_t>();
