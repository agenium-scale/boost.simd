...
STF_CASE_TPL( "Check Third behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Third<T>(); };

  auto pack  = bs::Third<pack_t>();
  auto hpack = bs::Third<hpack_t>();
  auto dpack = bs::Third<dpack_t>();
