...
STF_CASE_TPL( "Check Limitexponent behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Limitexponent<T>(); };

  auto pack  = bs::Limitexponent<pack_t>();
  auto hpack = bs::Limitexponent<hpack_t>();
  auto dpack = bs::Limitexponent<dpack_t>();
