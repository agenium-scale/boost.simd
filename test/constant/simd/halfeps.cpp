...
STF_CASE_TPL( "Check Halfeps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Halfeps<T>(); };

  auto pack  = bs::Halfeps<pack_t>();
  auto hpack = bs::Halfeps<hpack_t>();
  auto dpack = bs::Halfeps<dpack_t>();
