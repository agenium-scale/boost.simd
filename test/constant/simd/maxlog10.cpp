...
STF_CASE_TPL( "Check Maxlog10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxlog10<T>(); };

  auto pack  = bs::Maxlog10<pack_t>();
  auto hpack = bs::Maxlog10<hpack_t>();
  auto dpack = bs::Maxlog10<dpack_t>();
