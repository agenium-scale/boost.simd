...
STF_CASE_TPL( "Check Pio2_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_2<T>(); };

  auto pack  = bs::Pio2_2<pack_t>();
  auto hpack = bs::Pio2_2<hpack_t>();
  auto dpack = bs::Pio2_2<dpack_t>();
