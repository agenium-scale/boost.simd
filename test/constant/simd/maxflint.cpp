...
STF_CASE_TPL( "Check Maxflint behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Maxflint<T>(); };

  auto pack  = bs::Maxflint<pack_t>();
  auto hpack = bs::Maxflint<hpack_t>();
  auto dpack = bs::Maxflint<dpack_t>();
