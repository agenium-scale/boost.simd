...
STF_CASE_TPL( "Check Pix2_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pix2_2<T>(); };

  auto pack  = bs::Pix2_2<pack_t>();
  auto hpack = bs::Pix2_2<hpack_t>();
  auto dpack = bs::Pix2_2<dpack_t>();
