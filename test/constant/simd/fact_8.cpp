...
STF_CASE_TPL( "Check Fact_8 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_8<T>(); };

  auto pack  = bs::Fact_8<pack_t>();
  auto hpack = bs::Fact_8<hpack_t>();
  auto dpack = bs::Fact_8<dpack_t>();
