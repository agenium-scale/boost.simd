...
STF_CASE_TPL( "Check Mask2frexp behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mask2frexp<T>(); };

  auto pack  = bs::Mask2frexp<pack_t>();
  auto hpack = bs::Mask2frexp<hpack_t>();
  auto dpack = bs::Mask2frexp<dpack_t>();
