...
STF_CASE_TPL( "Check Expx2c2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Expx2c2<T>(); };

  auto pack  = bs::Expx2c2<pack_t>();
  auto hpack = bs::Expx2c2<hpack_t>();
  auto dpack = bs::Expx2c2<dpack_t>();
