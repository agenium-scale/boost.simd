...
STF_CASE_TPL( "Check Fourthrooteps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fourthrooteps<T>(); };

  auto pack  = bs::Fourthrooteps<pack_t>();
  auto hpack = bs::Fourthrooteps<hpack_t>();
  auto dpack = bs::Fourthrooteps<dpack_t>();
