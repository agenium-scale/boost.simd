...
STF_CASE_TPL( "Check Mlog2two2nmb behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mlog2two2nmb<T>(); };

  auto pack  = bs::Mlog2two2nmb<pack_t>();
  auto hpack = bs::Mlog2two2nmb<hpack_t>();
  auto dpack = bs::Mlog2two2nmb<dpack_t>();
