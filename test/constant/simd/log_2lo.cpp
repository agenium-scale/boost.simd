...
STF_CASE_TPL( "Check Log_2lo behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log_2lo<T>(); };

  auto pack  = bs::Log_2lo<pack_t>();
  auto hpack = bs::Log_2lo<hpack_t>();
  auto dpack = bs::Log_2lo<dpack_t>();
