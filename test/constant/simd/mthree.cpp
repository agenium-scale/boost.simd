...
STF_CASE_TPL( "Check Mthree behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mthree<T>(); };

  auto pack  = bs::Mthree<pack_t>();
  auto hpack = bs::Mthree<hpack_t>();
  auto dpack = bs::Mthree<dpack_t>();
