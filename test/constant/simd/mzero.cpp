...
STF_CASE_TPL( "Check Mzero behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mzero<T>(); };

  auto pack  = bs::Mzero<pack_t>();
  auto hpack = bs::Mzero<hpack_t>();
  auto dpack = bs::Mzero<dpack_t>();
