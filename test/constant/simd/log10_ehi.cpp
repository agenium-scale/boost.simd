...
STF_CASE_TPL( "Check Log10_ehi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log10_ehi<T>(); };

  auto pack  = bs::Log10_ehi<pack_t>();
  auto hpack = bs::Log10_ehi<hpack_t>();
  auto dpack = bs::Log10_ehi<dpack_t>();
