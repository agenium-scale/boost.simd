...
STF_CASE_TPL( "Check Mfive behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mfive<T>(); };

  auto pack  = bs::Mfive<pack_t>();
  auto hpack = bs::Mfive<hpack_t>();
  auto dpack = bs::Mfive<dpack_t>();
