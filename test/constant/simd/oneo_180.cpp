...
STF_CASE_TPL( "Check Oneo_180 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_180<T>(); };

  auto pack  = bs::Oneo_180<pack_t>();
  auto hpack = bs::Oneo_180<hpack_t>();
  auto dpack = bs::Oneo_180<dpack_t>();
