...
STF_CASE_TPL( "Check Oneosqrt5 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneosqrt5<T>(); };

  auto pack  = bs::Oneosqrt5<pack_t>();
  auto hpack = bs::Oneosqrt5<hpack_t>();
  auto dpack = bs::Oneosqrt5<dpack_t>();
