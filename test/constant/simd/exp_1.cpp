...
STF_CASE_TPL( "Check Exp_1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Exp_1<T>(); };

  auto pack  = bs::Exp_1<pack_t>();
  auto hpack = bs::Exp_1<hpack_t>();
  auto dpack = bs::Exp_1<dpack_t>();
