...
STF_CASE_TPL( "Check Oneo_16 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_16<T>(); };

  auto pack  = bs::Oneo_16<pack_t>();
  auto hpack = bs::Oneo_16<hpack_t>();
  auto dpack = bs::Oneo_16<dpack_t>();
