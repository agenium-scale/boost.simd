...
STF_CASE_TPL( "Check Twelve behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twelve<T>(); };

  auto pack  = bs::Twelve<pack_t>();
  auto hpack = bs::Twelve<hpack_t>();
  auto dpack = bs::Twelve<dpack_t>();
