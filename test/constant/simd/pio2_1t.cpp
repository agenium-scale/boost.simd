...
STF_CASE_TPL( "Check Pio2_1t behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio2_1t<T>(); };

  auto pack  = bs::Pio2_1t<pack_t>();
  auto hpack = bs::Pio2_1t<hpack_t>();
  auto dpack = bs::Pio2_1t<dpack_t>();
