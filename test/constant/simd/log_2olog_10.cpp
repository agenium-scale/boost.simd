...
STF_CASE_TPL( "Check Log_2olog_10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Log_2olog_10<T>(); };

  auto pack  = bs::Log_2olog_10<pack_t>();
  auto hpack = bs::Log_2olog_10<hpack_t>();
  auto dpack = bs::Log_2olog_10<dpack_t>();
