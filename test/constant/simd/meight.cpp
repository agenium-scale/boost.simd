...
STF_CASE_TPL( "Check Meight behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Meight<T>(); };

  auto pack  = bs::Meight<pack_t>();
  auto hpack = bs::Meight<hpack_t>();
  auto dpack = bs::Meight<dpack_t>();
