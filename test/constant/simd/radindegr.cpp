...
STF_CASE_TPL( "Check Radindegr behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Radindegr<T>(); };

  auto pack  = bs::Radindegr<pack_t>();
  auto hpack = bs::Radindegr<hpack_t>();
  auto dpack = bs::Radindegr<dpack_t>();
