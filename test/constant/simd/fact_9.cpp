...
STF_CASE_TPL( "Check Fact_9 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_9<T>(); };

  auto pack  = bs::Fact_9<pack_t>();
  auto hpack = bs::Fact_9<hpack_t>();
  auto dpack = bs::Fact_9<dpack_t>();
