...
STF_CASE_TPL( "Check Twopio_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twopio_3<T>(); };

  auto pack  = bs::Twopio_3<pack_t>();
  auto hpack = bs::Twopio_3<hpack_t>();
  auto dpack = bs::Twopio_3<dpack_t>();
