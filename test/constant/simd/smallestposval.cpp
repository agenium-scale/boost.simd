...
STF_CASE_TPL( "Check Smallestposval behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Smallestposval<T>(); };

  auto pack  = bs::Smallestposval<pack_t>();
  auto hpack = bs::Smallestposval<hpack_t>();
  auto dpack = bs::Smallestposval<dpack_t>();
