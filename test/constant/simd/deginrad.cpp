...
STF_CASE_TPL( "Check Deginrad behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Deginrad<T>(); };

  auto pack  = bs::Deginrad<pack_t>();
  auto hpack = bs::Deginrad<hpack_t>();
  auto dpack = bs::Deginrad<dpack_t>();
