...
STF_CASE_TPL( "Check Twoto31 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Twoto31<T>(); };

  auto pack  = bs::Twoto31<pack_t>();
  auto hpack = bs::Twoto31<hpack_t>();
  auto dpack = bs::Twoto31<dpack_t>();
