...
STF_CASE_TPL( "Check Hundred behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Hundred<T>(); };

  auto pack  = bs::Hundred<pack_t>();
  auto hpack = bs::Hundred<hpack_t>();
  auto dpack = bs::Hundred<dpack_t>();
