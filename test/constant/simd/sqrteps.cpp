...
STF_CASE_TPL( "Check Sqrteps behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrteps<T>(); };

  auto pack  = bs::Sqrteps<pack_t>();
  auto hpack = bs::Sqrteps<hpack_t>();
  auto dpack = bs::Sqrteps<dpack_t>();
