...
STF_CASE_TPL( "Check Sqrtpio_2 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrtpio_2<T>(); };

  auto pack  = bs::Sqrtpio_2<pack_t>();
  auto hpack = bs::Sqrtpio_2<hpack_t>();
  auto dpack = bs::Sqrtpio_2<dpack_t>();
