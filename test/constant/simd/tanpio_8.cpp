...
STF_CASE_TPL( "Check Tanpio_8 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Tanpio_8<T>(); };

  auto pack  = bs::Tanpio_8<pack_t>();
  auto hpack = bs::Tanpio_8<hpack_t>();
  auto dpack = bs::Tanpio_8<dpack_t>();
