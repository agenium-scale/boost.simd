...
STF_CASE_TPL( "Check Invlog_10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Invlog_10<T>(); };

  auto pack  = bs::Invlog_10<pack_t>();
  auto hpack = bs::Invlog_10<hpack_t>();
  auto dpack = bs::Invlog_10<dpack_t>();
