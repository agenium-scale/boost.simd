...
STF_CASE_TPL( "Check Pio_3 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Pio_3<T>(); };

  auto pack  = bs::Pio_3<pack_t>();
  auto hpack = bs::Pio_3<hpack_t>();
  auto dpack = bs::Pio_3<dpack_t>();
