...
STF_CASE_TPL( "Check Oneo_7 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Oneo_7<T>(); };

  auto pack  = bs::Oneo_7<pack_t>();
  auto hpack = bs::Oneo_7<hpack_t>();
  auto dpack = bs::Oneo_7<dpack_t>();
