...
STF_CASE_TPL( "Check Fact_11 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_11<T>(); };

  auto pack  = bs::Fact_11<pack_t>();
  auto hpack = bs::Fact_11<hpack_t>();
  auto dpack = bs::Fact_11<dpack_t>();
