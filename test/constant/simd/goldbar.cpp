...
STF_CASE_TPL( "Check Goldbar behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Goldbar<T>(); };

  auto pack  = bs::Goldbar<pack_t>();
  auto hpack = bs::Goldbar<hpack_t>();
  auto dpack = bs::Goldbar<dpack_t>();
