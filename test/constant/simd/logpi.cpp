...
STF_CASE_TPL( "Check Logpi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Logpi<T>(); };

  auto pack  = bs::Logpi<pack_t>();
  auto hpack = bs::Logpi<hpack_t>();
  auto dpack = bs::Logpi<dpack_t>();
