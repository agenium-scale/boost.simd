...
STF_CASE_TPL( "Check Mlog10two2nmb behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Mlog10two2nmb<T>(); };

  auto pack  = bs::Mlog10two2nmb<pack_t>();
  auto hpack = bs::Mlog10two2nmb<hpack_t>();
  auto dpack = bs::Mlog10two2nmb<dpack_t>();
