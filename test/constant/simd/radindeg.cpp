...
STF_CASE_TPL( "Check Radindeg behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Radindeg<T>(); };

  auto pack  = bs::Radindeg<pack_t>();
  auto hpack = bs::Radindeg<hpack_t>();
  auto dpack = bs::Radindeg<dpack_t>();
