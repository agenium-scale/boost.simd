...
STF_CASE_TPL( "Check Tan_3pio_8 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Tan_3pio_8<T>(); };

  auto pack  = bs::Tan_3pio_8<pack_t>();
  auto hpack = bs::Tan_3pio_8<hpack_t>();
  auto dpack = bs::Tan_3pio_8<dpack_t>();
