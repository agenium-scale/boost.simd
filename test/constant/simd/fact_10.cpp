...
STF_CASE_TPL( "Check Fact_10 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Fact_10<T>(); };

  auto pack  = bs::Fact_10<pack_t>();
  auto hpack = bs::Fact_10<hpack_t>();
  auto dpack = bs::Fact_10<dpack_t>();
