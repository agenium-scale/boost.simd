...
STF_CASE_TPL( "Check Expx2c1 behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Expx2c1<T>(); };

  auto pack  = bs::Expx2c1<pack_t>();
  auto hpack = bs::Expx2c1<hpack_t>();
  auto dpack = bs::Expx2c1<dpack_t>();
