...
STF_CASE_TPL( "Check Three behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Three<T>(); };

  auto pack  = bs::Three<pack_t>();
  auto hpack = bs::Three<hpack_t>();
  auto dpack = bs::Three<dpack_t>();
