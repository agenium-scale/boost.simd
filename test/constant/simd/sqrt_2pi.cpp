...
STF_CASE_TPL( "Check Sqrt_2pi behavior"
            , (double)(float)
            ...
            )
{
  ...
  auto are_correct = [](T e) { return e == bs::Sqrt_2pi<T>(); };

  auto pack  = bs::Sqrt_2pi<pack_t>();
  auto hpack = bs::Sqrt_2pi<hpack_t>();
  auto dpack = bs::Sqrt_2pi<dpack_t>();
