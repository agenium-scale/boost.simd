...
STF_CASE_TPL (" atan2",  STF_IEEE_TYPES)
{
 ...
 STF_ULP_EQUAL(atan2(bs::Minf<T>(),bs::Minf<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Inf<T>(),bs::Minf<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Minf<T>(),bs::Inf<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Inf<T>(),bs::Inf<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Minf<T>(), bs::Minf<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Zero<T>(), bs::Zero<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Mzero<T>(), bs::Mzero<T>()), bs::Nan<r_t>(), 0.5);
 STF_ULP_EQUAL(atan2(bs::Zero<T>(), bs::Mzero<T>()), bs::Nan<r_t>(), 0.5);
