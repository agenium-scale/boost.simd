...
STF_CASE_TPL (" div unsigned_int",  STF_UNSIGNED_INTEGRAL_TYPES)
{
  ...
  STF_EQUAL(div(bs::iceil, T(4),T(0)), bs::Valmax<r_t>());
  STF_EQUAL(div(bs::iceil, T(4),T(3)), T(2));
  STF_EQUAL(div(bs::iceil, bs::One<T>(), bs::One<T>()), bs::One<r_t>());
  STF_EQUAL(div(bs::iceil, bs::Valmax<T>(),  bs::Two<T>()), bs::Valmax<r_t>()/bs::Two<T>()+bs::One<T>());
...
STF_CASE_TPL (" div signed_int",  STF_SIGNED_INTEGRAL_TYPES)
{
  ...
  STF_EQUAL(div(bs::iceil, T(-4),T(0)), bs::Valmin<r_t>());
  STF_EQUAL(div(bs::iceil, T(4),T(0)), bs::Valmax<r_t>());
  STF_EQUAL(div(bs::iceil, T(4),T(3)), T(2));
  STF_EQUAL(div(bs::iceil, T(-4),T(-3)), T(2));
  STF_EQUAL(div(bs::iceil, T(4),T(-3)), T(-1));
  STF_EQUAL(div(bs::iceil, T(-4),T(3)), T(-1));
  STF_EQUAL(div(bs::iceil, bs::Mone<T>(), bs::Mone<T>()), bs::One<r_t>());
  STF_EQUAL(div(bs::iceil, bs::One<T>(), bs::One<T>()), bs::One<r_t>());
