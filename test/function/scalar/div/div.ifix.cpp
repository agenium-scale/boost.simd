...
STF_CASE_TPL (" divifix real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;

  using bs::div;
  using r_t = decltype(div(bs::ifix, T(), T()));
...
STF_CASE_TPL (" divifix unsigned_int",  STF_UNSIGNED_INTEGRAL_TYPES)
{
  ...
  // specific values tests
  STF_EQUAL(div(bs::ifix, T(4),T(0)), bs::Valmax<r_t>());
  STF_EQUAL(div(bs::ifix, T(4),T(3)), T(1));
  STF_EQUAL(div(bs::ifix, bs::One<T>(), bs::One<T>()), bs::One<T>());
  STF_EQUAL(div(bs::ifix, bs::Zero<T>(), bs::Zero<T>()), bs::Zero<T>());
  STF_EQUAL(div(bs::ifix, bs::One<T>(), bs::Zero<T>()), bs::Valmax<r_t>());
} // end of test for unsigned_int_

STF_CASE_TPL (" divifix signed_int",  STF_SIGNED_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  using bs::div;
  using r_t = decltype(div(bs::ifix, T(), T()));
  ...
  // specific values tests
  STF_EQUAL(div(bs::ifix, T(-4),T(0)), bs::Valmin<r_t>());
  STF_EQUAL(div(bs::ifix, T(4),T(0)), bs::Valmax<r_t>());
  STF_EQUAL(div(bs::ifix, T(4),T(3)), T(1));
  STF_EQUAL(div(bs::ifix, T(-4),T(-3)), T(1));
  STF_EQUAL(div(bs::ifix, T(4),T(-3)), T(-1));
  ...
  STF_EQUAL(div(bs::ifix, bs::Mone<T>(), bs::Mone<T>()), bs::One<r_t>());
  STF_EQUAL(div(bs::ifix, bs::One<T>(), bs::One<T>()), bs::One<r_t>());
  STF_EQUAL(div(bs::ifix, bs::Mone<T>(), bs::Zero<T>()), bs::Valmin<r_t>());
  STF_EQUAL(div(bs::ifix, bs::One<T>(), bs::Zero<T>()), bs::Valmax<r_t>());
  STF_EQUAL(div(bs::ifix, bs::Valmax<T>(),bs::One<T>()), bs::Valmax<T>());
