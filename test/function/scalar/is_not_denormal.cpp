...
STF_CASE_TPL (" is_not_denormal",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_denormal;

  using r_t = decltype(is_not_denormal(T()));
...
STF_CASE_TPL (" is_not_denormal signed_int",  STF_SIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_denormal;
...
STF_CASE_TPL (" is_not_denormal unsigned_int__1_0",  STF_UNSIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_denormal;
...
STF_CASE ( "is_not_denormal bool")
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_denormal;
  using r_t = decltype(is_not_denormal(bool()));

  // return type conformity test
  STF_TYPE_IS(r_t, bool);

  // specific values tests
  STF_EQUAL(is_not_denormal(true), true);
  STF_EQUAL(is_not_denormal(true), true);
}
