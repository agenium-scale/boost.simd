...
STF_CASE_TPL (" is_flint real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_flint;
  using r_t = decltype(is_flint(T()));
...
STF_CASE_TPL (" is_flint signed_int",  STF_SIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_flint;
...
STF_CASE_TPL (" is_flint unsigned_int",  STF_UNSIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_flint;
...
STF_CASE ( "is_flint bool")
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_flint;
  using r_t = decltype(is_flint(bool()));

  // return type conformity test
  STF_TYPE_IS(r_t, bool);

  // specific values tests
  STF_EQUAL(is_flint(true), true);
  STF_EQUAL(is_flint(false), true);
}
