...
STF_CASE_TPL (" is_not_greater_equal integer",  STF_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_greater_equal;
  using r_t = decltype(is_not_greater_equal(T(), T()));

  // return type conformity test
  STF_TYPE_IS(r_t, bs::logical<T>);

  // specific values tests
  STF_EQUAL(is_not_greater_equal(bs::One<T>(), bs::One<T>()), r_t(false));
...
STF_CASE_TPL (" is_not_greater_equal real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_not_greater_equal;
...
STF_CASE ( "is_not_greater_equal bool")
{
  ...
  using r_t = decltype(is_not_greater_equal(bool(), bool()));
