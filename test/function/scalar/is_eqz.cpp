...
STF_CASE_TPL (" is_eqz real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_eqz;
  using r_t = decltype(is_eqz(T()));
...
STF_CASE_TPL (" is_eqz signed_int",  STF_SIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_eqz;
...
STF_CASE_TPL (" is_eqz unsigned_int",  STF_UNSIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_eqz;
...
STF_CASE ( "is_eqz bool")
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::is_eqz;
  using r_t = decltype(is_eqz(bool()));

  // return type conformity test
  STF_TYPE_IS(r_t, bool);

  // specific values tests
  STF_EQUAL(is_eqz(true), false);
  STF_EQUAL(is_eqz(false), true);
}
