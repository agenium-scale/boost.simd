...
//TODO LOGICAL
STF_CASE_TPL (" if_allbits_else real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::if_allbits_else;
  using bs::logical;
  using bs::Nan;
...
//   STF_IEEE_EQUAL(if_allbits_else(bs::True< bs::logical<T> >(), T(1)), Nan<T>());
//   STF_EQUAL(if_allbits_else(bs::False< bs::logical<T> >(), T(1)), T(1));
...
STF_CASE_TPL (" if_allbits_elsesigned_ int",  STF_SIGNED_ALL_INTEGRAL_TYPES)
{
  ...
  // specific values tests
  STF_EQUAL(if_allbits_else(T(0), T(1)), T(1));
  STF_EQUAL(if_allbits_else(T(1), T(1)), Allbits<T>());
//   STF_EQUAL(if_allbits_else(bs::True< bs::logical<T> >(), T(1)), Allbits<T>());
//   STF_EQUAL(if_allbits_else(bs::False< bs::logical<T> >(), T(1)), T(1));
