...
STF_CASE_TPL (" minnummag real",  STF_IEEE_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::minnummag;

  using r_t = decltype(minnummag(T(), T()));
...
STF_CASE_TPL (" minnummag unsigned_int",  STF_UNSIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::minnummag;
...
STF_CASE_TPL (" minnummag signed_int",  STF_SIGNED_ALL_INTEGRAL_TYPES)
{
  namespace bs = boost::simd;
  namespace bd = boost::dispatch;
  using bs::minnummag;
  ...
  STF_EQUAL(minnummag(bs::One<T>(), bs::One<T>()), bs::One<r_t>());
  STF_EQUAL(minnummag(bs::Zero<T>(), bs::Zero<T>()), bs::Zero<r_t>());
  STF_EQUAL(minnummag(bs::Mone<T>(), bs::Zero<T>()), bs::Zero<r_t>());
  STF_EQUAL(minnummag(bs::Mone<T>(), bs::One<T>()), bs::Mone<r_t>());
}
