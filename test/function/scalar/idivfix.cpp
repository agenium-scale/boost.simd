...
STF_CASE_TPL (" div real",  STF_IEEE_TYPES)
{
  ...
  STF_EQUAL(div(bs::ifix, bs::Inf<T>(), bs::Inf<T>()), bs::Zero<r_t>());
  ...
  STF_EQUAL(div(bs::ifix, bs::One<T>(),bs::Mzero<T>()), bs::Valmin<r_t>());
  STF_EQUAL(div(bs::ifix, bs::Zero<T>(),bs::Zero<T>()), bs::Zero<r_t>());
