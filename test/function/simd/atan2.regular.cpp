...
STF_CASE_TPL (" atan2",  STF_IEEE_TYPES)
{
  ...
  STF_ULP_EQUAL(atan2(bs::Minf<p_t>(),bs::Minf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Inf<p_t>(),bs::Minf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Minf<p_t>(),bs::Inf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Inf<p_t>(),bs::Inf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Inf<p_t>(), bs::Inf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Inf<p_t>(),bs::One<p_t>()), bs::Pio_2<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Minf<p_t>(), bs::Minf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Minf<p_t>(),bs::One<p_t>()), -bs::Pio_2<r_t>(), 0.5);
  ...
  STF_ULP_EQUAL(atan2(bs::Zero<p_t>(), bs::Zero<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Mzero<p_t>(), bs::Zero<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Mzero<p_t>(), bs::Mzero<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Mzero<p_t>(), bs::Mone<p_t>()), -bs::Pi<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2(bs::Zero<p_t>(), bs::Mzero<p_t>()),bs::Nan<r_t>(), 0.5);
