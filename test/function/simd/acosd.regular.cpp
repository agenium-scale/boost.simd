...
void test(Env& $)
{
  ...
  p_t aa1(&a1[0], &a1[0]+N);
  p_t bb (&b[0], &b[0]+N);
  STF_ULP_EQUAL(bs::acosd(aa1), bb, 2);
}
...
STF_CASE_TPL (" acosd",  STF_IEEE_TYPES)
{
  ...
  STF_ULP_EQUAL(bs::acosd(bs::Mone<p_t>()), r_t(180), 0.5);
  STF_ULP_EQUAL(bs::acosd(bs::One<p_t>()), bs::Zero<r_t>(), 0.5);
  STF_ULP_EQUAL(bs::acosd(bs::Zero<p_t>()), r_t(90), 0.5);
}
