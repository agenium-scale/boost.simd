...
STF_CASE_TPL (" atan2pi",  STF_IEEE_TYPES)
{
  ...
  STF_ULP_EQUAL(atan2pi(bs::Inf<p_t>(), bs::Inf<p_t>()), bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2pi(bs::Inf<p_t>(),bs::One<p_t>()), p_t(0.5), 0.5);
  STF_ULP_EQUAL(atan2pi(bs::Minf<p_t>(), bs::Minf<p_t>()), bs::Nan<r_t>(), 0.5);
  ...
  STF_ULP_EQUAL(atan2pi(bs::Zero<p_t>(), bs::Zero<p_t>()),bs::Nan<r_t>(), 0.5);
}
