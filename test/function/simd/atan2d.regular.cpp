...
STF_CASE_TPL (" atan2d",  STF_IEEE_TYPES)
{
  ...
  STF_ULP_EQUAL(atan2d(bs::Inf<p_t>(), bs::Inf<p_t>()),bs::Nan<r_t>(), 0.5);
  STF_ULP_EQUAL(atan2d(bs::Inf<p_t>(),bs::One<p_t>()), p_t(90), 0.5);
  STF_ULP_EQUAL(atan2d(bs::Minf<p_t>(), bs::Minf<p_t>()), bs::Nan<r_t>(), 0.5);
  ...
  STF_ULP_EQUAL(atan2d(bs::Zero<p_t>(), bs::Zero<p_t>()), bs::Nan<r_t>(), 0.5);
}
