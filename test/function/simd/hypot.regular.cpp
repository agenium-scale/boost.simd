...
STF_CASE_TPL (" hypot real",  STF_IEEE_TYPES)
{
  ...
  STF_ULP_EQUAL(hypot(bs::Nan<p_t>(), bs::Inf<p_t>()), bs::Nan<r_t>(), 0);
  STF_ULP_EQUAL(hypot(bs::Inf<p_t>(), bs::Nan<p_t>()), bs::Nan<r_t>(), 0);
#endif
  ...
  STF_ULP_EQUAL(hypot(bs::Valmax<p_t>(), bs::Zero<p_t>()), bs::Inf<p_t>(), 0);
  STF_ULP_EQUAL(hypot(bs::Zero<p_t>(), bs::Valmax<p_t>()), bs::Inf<p_t>(), 0);
