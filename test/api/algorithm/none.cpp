...
*/
//==================================================================================================
#include <boost/simd/algorithm/none.hpp>
...
STF_CASE_TPL( "Check simd::none(f,l)", STF_NUMERIC_TYPES )
{
...

  {
    ...
    // All aligned
    STF_EQUAL ( true
              , (boost::simd::none(ab,ae))
              );

    // prologue + aligned
    STF_EQUAL ( true
              , (boost::simd::none(ab+1,ae))
              );

    // aligned + epilogue
    STF_EQUAL ( true
              , (boost::simd::none(ab,ae-1))
              );

    // prologue + epilogue
    STF_EQUAL ( true
              , (boost::simd::none(ab+1,ae-1))
              );
  }
  {
