...
STF_CASE_TPL("perfect iteration", STF_NUMERIC_TYPES)
{
  ...
  STF_EQUAL( std::distance(rg::begin(std::get<0>(pr)),rg::end(std::get<0>(pr))), 0);
  STF_EQUAL( std::distance(rg::begin(std::get<2>(pr)),rg::end(std::get<2>(pr))), 0);
...
STF_CASE_TPL("iteration with prologue", STF_NUMERIC_TYPES)
{
  ...
  T v = 0;
  std::size_t l0 = std::distance(rg::begin(std::get<0>(pr)),rg::end(std::get<0>(pr)));
  std::size_t l1 = std::distance(rg::begin(std::get<1>(pr)),rg::end(std::get<1>(pr)));
...
STF_CASE_TPL("iteration with epilogue & prologue", STF_NUMERIC_TYPES)
{
  ...
  STF_EXPECT( std::distance(rg::begin(std::get<0>(pr)),rg::end(std::get<0>(pr))) != 0);
  STF_EXPECT( std::distance(rg::begin(std::get<2>(pr)),rg::end(std::get<2>(pr))) != 0);
  STF_ALL_EQUAL(ref, data);
}
