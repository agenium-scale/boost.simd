...
int main()
{
  ...
  std::cout
    ...
    << "<- pf =                  " << pf << '\n'
    << "<- qf =                  " << pf << '\n'
    << "-> bs::is_not_equal_with_equal_nans(pf, qf) = " << bs::is_not_equal_with_equal_nans(pf, qf) << '\n';
  ...
  std::cout
    ...
    << "<- xf =                  " << xf << '\n'
    << "<- yf =                  " << yf << '\n'
    << "-> bs::is_not_equal_with_equal_nans(xf, yf) = " << bs::is_not_equal_with_equal_nans(xf, yf) << '\n';
  return 0;
}
//! [is_not_equal_with_equal_nans]
