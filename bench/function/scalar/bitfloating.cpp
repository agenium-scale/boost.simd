...
int main(int argc, char **argv) {
   ...
   nsb::make_for_each<bitfloating_scalar, std::int32_t, std::int64_t>( -10,  10);
   nsb::make_for_each<bitfloating_scalar, std::uint32_t, std::uint64_t>(0,  10);
   return 0;
}
