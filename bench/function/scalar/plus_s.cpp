...
struct plus_s_scalar
{
   ...
   void operator()(U min0, U max0, U min1, U max1)
   {
     ...
     nsb::make_function_experiment_cpe_sized_<1>
       ...
       { return bs::saturated_(bs::plus)(x0, x1); }
...
int main(int argc, char **argv) {
   ...
   nsb::make_for_each<plus_s_scalar, NS_BENCH_SIGNED_NUMERIC_TYPES>( -10,  10,  -10,  10);
   nsb::make_for_each<plus_s_scalar, NS_BENCH_UNSIGNED_NUMERIC_TYPES>(0,  10, 0,  10);
   return 0;
}
