...
struct hi_simd
{
   ...
   void operator()(U min0, U max0)
   {
     ...
     using ret_type = bd::as_integer_t<pack_t,unsigned>;
...
int main(int argc, char **argv) {
   ...
   nsb::make_for_each<hi_simd, NS_BENCH_SIGNED_NUMERIC_TYPES>( -10,  10);
   nsb::make_for_each<hi_simd, NS_BENCH_UNSIGNED_NUMERIC_TYPES>(0,  10);
   return 0;
}
