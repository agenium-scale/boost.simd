...
struct rol_simd
{
   ...
   void operator()(U min0, U max0, U min1, U max1)
   {
     ...
     using ipack_t = bs::pack<bd::as_integer_t<T, unsigned>>;
...
int main(int argc, char **argv) {
   ...
   nsb::make_for_each<rol_simd, NS_BENCH_SIGNED_NUMERIC_TYPES>( -10,  10,  0,  7);
   nsb::make_for_each<rol_simd, NS_BENCH_UNSIGNED_NUMERIC_TYPES>(0,  10, 0,  7);
   return 0;
}
