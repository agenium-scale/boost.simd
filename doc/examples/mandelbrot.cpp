...
// uncomment the two include lines and the two other commented areas with the same front line as this one
// this suppose you have opencv installed and the proper libraries on your compilation command
...
struct mandelbrot{
  ...
  //! [mandelbrot-simd]
  void evaluate_simd(){
    pack_t step =  bs::enumerate<pack_t>(0);// produce a vector containing {0, 1, ..., pack_t::static_size-1}
    for(int i = 0; i < size; ++i){
...
//    g++ mandelbrot.cpp -msse4.2 -std=c++11 -O3 -DNDEBUG -o mandelbrot -I/pathto/boost_simd//include -I/pathto/boost
// or if you uncomment the opencv related lines to see the generated julia set and use:
//    g++ mandelbrot.cpp -msse4.2 -std=c++11 -O3 -DNDEBUG -o mandelbrot -I/pathto/boost_simd//include -I/pathto/boost -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_contrib
